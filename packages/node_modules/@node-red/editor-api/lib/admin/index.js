...
module.exports = {
    init: function(settings,runtimeAPI) {
        ...
        adminApp.get("/ithings/flow/list", needsPermission("flows.read"), ithings.getFlowTabs, apiUtil.errorHandler);
        adminApp.post("/ithings/flow/add", needsPermission("flows.write"), ithings.addFlow, apiUtil.errorHandler);
        adminApp.post("/ithings/flow/state/:id", needsPermission("flows.write"), ithings.setFlowState, apiUtil.errorHandler);
        adminApp.delete("/ithings/flow/:id", needsPermission("flows.write"), ithings.deleteFlow, apiUtil.errorHandler);
